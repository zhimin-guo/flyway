 ...
 * Oracle connection.
 */
public class DBMSConnection extends Connection<DBMSDatabase> {
    DBMSConnection(DBMSDatabase database, java.sql.Connection connection) {
    ...
    public Schema getSchema(String name) {
        return new DBMSSchema(jdbcTemplate, database, name);
    }
}
