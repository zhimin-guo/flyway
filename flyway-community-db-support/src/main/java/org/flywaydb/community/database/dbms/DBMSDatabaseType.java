...
public class DBMSDatabaseType extends BaseDatabaseType {
    private static final Pattern usernamePasswordPattern = Pattern.compile("^jdbc:dm:*");
    ...
    public Database createDatabase(Configuration configuration, JdbcConnectionFactory jdbcConnectionFactory, StatementInterceptor statementInterceptor) {
        DBMSDatabase.enableTnsnamesOraSupport();

        return new DBMSDatabase(configuration, jdbcConnectionFactory, statementInterceptor);
    }

    @Override
    public Parser createParser(Configuration configuration, ResourceProvider resourceProvider, ParsingContext parsingContext) {
        return new DBMSParser(configuration, parsingContext);
    }
    ...
    public SqlScriptExecutorFactory createSqlScriptExecutorFactory(JdbcConnectionFactory jdbcConnectionFactory,
        ...
        return new SqlScriptExecutorFactory() {
            ...
            public SqlScriptExecutor createSqlScriptExecutor(Connection connection , boolean undo, boolean batch, boolean outputQueryResults) {
                return new DBMSSqlScriptExecutor(new JdbcTemplate(connection, thisRef)
