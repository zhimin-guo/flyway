 ...
 */
public class DBMSTable extends Table<DBMSDatabase, DBMSSchema> {
    /**
     ...
     */
    public DBMSTable(JdbcTemplate jdbcTemplate, DBMSDatabase database, DBMSSchema schema, String name) {
